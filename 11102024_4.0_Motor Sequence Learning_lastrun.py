...
expName = '11102024_4.0_Motor Sequence Learning'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Dell\\OneDrive\\Desktop\\PSY310\\5 motor sequence\\11102024_4.0_Motor Sequence Learning_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('sequence_condition.csv'), 
        seed=None, 
    )
