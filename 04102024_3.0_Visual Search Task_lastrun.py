...
expName = '04102024_3.0_Visual Search Task'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Dell\\OneDrive\\Desktop\\PSY310\\4 visual search task\\04102024_3.0_Visual Search Task_lastrun.py',
