...
expName = 'intentional binding exp'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Dell\\OneDrive\\Desktop\\PSY310\\8 intentional binding\\intentional binding exp_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Report the delay between key press and the beep sound (0-999): Click submit after entering the value.',
        font='Arial',
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('ib.cons.xlsx'), 
        seed=None, 
    )
